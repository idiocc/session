 ...
 * @prop {function(): !Promise<void>} manuallyCommit Session headers are auto committed by default. Use this if `autoCommit` is set to false.
 */
 ...
 * @prop {function(string,!Object,number|string,{ rolling: boolean, changed: boolean }): !Promise} set Set session object for key, with a `maxAge` (in ms, or as `'session'`).
 ...
 * @prop {function(!_goa.Context,!Object): boolean} [valid] The validation hook: valid session value before use it.
